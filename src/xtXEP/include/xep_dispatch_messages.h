 ...
 * @return Status of execution
 */
uint32_t dispatch_message_hostcom_send_data_string(XepDispatch_t* dispatch, uint32_t contentid, uint32_t info, const char* format, ...)__attribute__((format(gnu_printf, 4, 5)));
 ...
 * @return Status of execution
 */
uint32_t dispatch_message_hostcom_send_appdata_respiration_movinglist(XepDispatch_t* dispatch, uint32_t counter, uint32_t interval_count, const float *movement_fast_item, const float *movement_slow_item);
 ...
 * @return Status of execution
 */
uint32_t dispatch_message_hostcom_send_appdata_respiration_detectionlist(XepDispatch_t* dispatch, uint32_t counter, uint32_t detection_count, const float *detection_distance, const float *detection_rcs, const float *detection_velocity);
 ...
 * @return Status of execution
 */
uint32_t dispatch_message_hostcom_send_appdata_presence_single(XepDispatch_t* dispatch, uint32_t counter, uint32_t presence_state, float distance, uint8_t direction, uint32_t signal_quality);
...
uint32_t dispatch_message_hostcom_send_appdata_pulsedoppler_float(
        XepDispatch_t* dispatch, uint32_t counter, uint32_t matrix_counter,
