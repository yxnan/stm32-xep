...
/**
 * @brief Store debug data to flash
 *
 * @return Status of execution as defined in @ref xtio_error_codes_t
 */
uint32_t xtio_flash_store_debug_data(uint8_t * buffer, uint32_t size);

/**
 * @brief Read debug data from flash
 *
 * @return Status of execution as defined in @ref xtio_error_codes_t
 */
uint32_t xtio_flash_read_debug_data(uint8_t* buffer, uint32_t max_size, uint32_t* size);
